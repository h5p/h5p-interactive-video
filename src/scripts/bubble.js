...
class Bubble {
  ...
  fullscreen (fullscreen = false, containerHeight = undefined, videoHeight = undefined) {
    const fontSize = (this.isMobilePhone() && fullscreen) ? '70%' : '';
    this.$bubble.css({
      fontSize: fontSize
    });
